...
var myApp = angular.module('myApp', ['ngRoute', 'config', 'LocalStorageModule', 'directive', 'restangular',
    ...
    'cgBusy', 'bootstrapLightbox', 'angular-dropdown-multiselect', 'angular-growl', 'ngAnimate'
]);
...
myApp.config(['uiGmapGoogleMapApiProvider', function (uiGmapGoogleMapApiProvider) {
    uiGmapGoogleMapApiProvider.configure({
        key: 'AIzaSyAnbuJ8QFGX74TvABO2Z0HRAc1H5oZMywA',
        v: '3.17',
...
myApp.config(["RestangularProvider", function (RestangularProvider) {
    ...
    RestangularProvider.setBaseUrl('http://qa.api.ratingscombined.com:80/v1/');
...
//                    $rootScope.errorStatus = 'Internal Server Error [500].';
                } else if (rejection.status == 422 && rejection.data && rejection.data.message) {
