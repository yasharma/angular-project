        ...
        getRestaurants: function(c) {
            ...
            return d.getList(merge_objects({
                ...
                for (var c = 0; c < b.length; c++) {
                    ...
                    b[c].trend_change = 0;
                    b[c].trend_change_abs = 0;
                    if (f && f.length > 1) {
                        var q, r;
                        for (var s in f[f.length - 1]) {
                            q = f[f.length - 1][s];
                        }
                        for (var t in f[f.length - 2]) {
                            r = f[f.length - 2][t];
                        }
                        b[c].trend_change = Math.round((parseFloat(q) - parseFloat(r)) * 10) / 10;
                        b[c].trend_change_abs = Math.abs(b[c].trend_change);
                    }
                }
                return {
                    items: b,
