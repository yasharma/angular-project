...
rxControllers.controller("graphCtrl", [ "$scope", "restaurantSvr", "$routeParams", function(a, b, c) {
    ...
    a.getGraphs = function() {
        b.getGraphs(a.restaurantId, a.graphDuration.value).then(function(b) {
            a.donutDataset = b.source;
        });
    };
    a.getGraphs();
    var d = {
    ...
    a.chartConfig = {
        ...
        subtitle: {
            text: "From " + d.min_dt + " to " + d.max_dt
        },
        xAxis: {
            type: "datetime"
        },
    ...
    var e = [ [ 0, 0 ], [ 1, 0 ], [ 2, 1 ], [ 3, 2 ], [ 4, 15 ], [ 5, 5 ], [ 6, 12 ], [ 7, 10 ], [ 8, 55 ], [ 9, 13 ], [ 10, 25 ], [ 11, 10 ], [ 12, 12 ], [ 13, 6 ], [ 14, 2 ], [ 15, 0 ], [ 16, 0 ] ];
    a.flotDataset = [ e ];
    a.flotOptions = {
        series: {
            lines: {
...
restaurantService.factory("restaurantSvr", [ "localStorageService", "Restangular", function(a, b) {
    return {
        ...
        getGraphs: function(a, c) {
            var d = "restaurants/" + a + "/graphs";
            var e = b.one(d);
            return e.get({
                duration: c,
