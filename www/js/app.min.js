    ...
    function k(b, c) {
        ...
        a.cgBusyPromise.then(function(d) {
            if (d.items.length == 0 && a.distanceFilterValue != 0 && c) {
                ...
                a.popularListCurrentPage = d._meta.currentPage;
            }
        });
    }
    a.options = {
...
rxControllers.controller("detailCtrl", [ "$scope", "$timeout", "$upload", "localStorageService", "$location", "$routeParams", "restaurantSvr", "geoLocation", "reviewSvr", "overviewSvr", "locationSvr", "photoSvr", "$anchorScroll", "$modal", function(a, b, c, d, e, f, g, h, i, j, k, l, m, n) {
    ...
    function s() {
        ...
        g.getRestaurant(b).then(function(c) {
            a.restaurant = c;
            g.getPhotos(b).then(function(b) {
                a.restaurant.restaurantPhotos = b;
                console.log(a.restaurant.restaurantPhotos);
            });
