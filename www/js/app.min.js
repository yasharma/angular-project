...
rxControllers.controller("graphCtrl", [ "$scope", "restaurantSvr", "$routeParams", function(a, b, c) {
    ...
    a.graphType = a.graphTypes[0];
    a.setGraphDuration = function(b) {
        a.graphDuration = b;
        a.getGraphs();
    };
    a.setGraphType = function(b) {
        a.graphType = b;
        a.getGraphs();
    };
    a.getGraphs = function() {
        b.getGraphs(a.restaurantId, a.graphDuration.value, a.graphType.value).then(function(b) {
            a.flotDataset = [ b.data ];
...
restaurantService.factory("restaurantSvr", [ "localStorageService", "Restangular", function(a, b) {
    return {
        ...
        getGraphs: function(a, c, d) {
            var e = "restaurants/" + a + "/graphs";
            var f = b.one(e);
            return f.get({
                duration: c,
