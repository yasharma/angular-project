...
rxControllers.config([ "$routeProvider", function(a) {
    ...
    function i(b) {
        ...
        a.cgBusyPromise = e.getRestaurants(b);
        a.cgBusyPromise.then(function(b) {
...
rxControllers.controller("photoCtrl", [ "$scope", "$routeParams", "photoSvr", "messageCenterService", function(a, b, c, d) {
    ...
    function f(b) {
        ...
        return c.getRestaurantPhotos(e, b).then(function(b) {
            a.photos = b.items;
            a.maxSize = 6;
    ...
    a.$watch("restaurantPhotos", function(b) {
        ...
        if (b) {
            for (var d = 0; d < b.length; d++) {
                ...
                c.uploadRestaurantPhoto(h).then(function(b) {
                    if (b.items.success) {
